...
uses
  ...
  FDTablePlus, FDConnectionPlus, CutUtils_Summs7, CutUtils_Summs8;
...
uses
  Windows, Summs, Times_Summs7, Times_Summs8, TicketsSplit, AdjFact, SummsVars,
...
//Note BasicAllowance & AdjustedAllowance must remain in sq units for times.
          ...
          begin
            ...
            begin
              ...
              begin
                dmTimes_Summs7.CalculateAllTimes(TRUE, qGetData.FieldByName('StdBatchSize').value, qGetData, qTimesGridFullBatch, LoopCount, Dummy, Ints4Ticket, FALSE);
                FullBatchError := FALSE;
              end
              else
              begin
                ...
                FullBatchError := dmCutUtils_Summs8.MessageShown;
              end;
...
//              FullBatchError := dmCutUtils_Summs8.MessageShown;
              ...
              begin
                if LegacyCuttingTimes then
                begin
                  dmTimes_Summs7.CalculateAllTimes(TRUE, SmallBatch, qGetData, qTimesGridSmallBatch, LoopCount, Dummy, Ints4Ticket, FALSE);
                  SmallBatchError := FALSE;
                end
                else
                begin
                  dmTimes_Summs8.CalculateAllTimes(TRUE, SmallBatch, qGetData, qTimesGridSmallBatch, LoopCount, Dummy, Ints4Ticket, FALSE);
                  SmallBatchError := dmCutUtils_Summs8.MessageShown;
                end;
...
begin
  ...
  begin
    SQLString := SQLString + #13 + 'INSERT INTO TicketsSplitInput ' +
                 ...
                 FloatToStrFSQL(Combinations[i].SizeSeq, ffGeneral, 15, 0) + ');';
...
procedure TdmTicketsAll.LocalConnectionSummsAfterConnect(Sender: TObject);
begin
