...
begin
  ...
  if messageDlg('Delete selected Parts?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
  begin
    ...
    messageDlg('Deletion complete.' + #13#13 + 'Note: Only Parts that are not' + #13 + 'in use have been deleted.', mtInformation, [mbOK], 0);
  end;
