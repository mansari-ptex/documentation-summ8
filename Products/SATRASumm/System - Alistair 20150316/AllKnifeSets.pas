...
begin
  ...
  if messageDlg('Delete selected Knives?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
  begin
    ...
    messageDlg('Deletion complete.' + #13#13 + 'Note: Only Knives that are not' + #13 + 'in use have been deleted.', mtInformation, [mbOK], 0);
  end;
