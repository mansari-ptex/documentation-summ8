  ...
  try
    ...
    begin
      ...
      if pos('CONSTRUC:PRIMARY', E.Message) > 0 then
        if MessageDlg('Construction already exists - Add to Style?', mtConfirmation, [mbYes, mbNo], 0) = mrNo then
          AddToStyle := False;
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        messagedlg('Construction NOT added to style', mtInformation, [mbOk], 0);
        LocalConnectionSumms.Rollback;
      end;
    end;
