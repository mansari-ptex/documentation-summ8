...
begin
  ...
  begin
    ...
    begin
      MessageDlg(IntToStr(SyntheticTicketCount) + ' parts are using Legacy Synthetics Allowance.' + sLinebreak + sLinebreak +
                 'To include a part, disable its Legacy Synthetics Allowance'+ sLinebreak +
                 'and recreate the ticket.', mtInformation, [mbOK], 0);
    end;
