...
uses
  ...
  FireDAC.Comp.Client, FDQueryPlus, FireDAC.Comp.DataSet, Dialogs, DateUtils;
...
var
  ...
  CommonWidth, NextSeq, SizeBySize, StopNow, StyleExists: boolean;
...
//            DataConn.BeginTransaction;
            ...
            begin
              ...
              begin
                ...
                begin
                  SQL.Add('DECLARE @WeekNo Integer;');
                  SQL.Add('DECLARE @Picture Blob;');
                  SQL.Add('DECLARE @SequenceNo Integer;');
                  ...
                  begin
                    ...
                    begin
                      SQL.Add('INSERT INTO TicketsInput (WeekNo, ' +
                                                         ...
                                                         'WidthNo, ' +
                                                         'SizeSeq) ' +
                               'VALUES (@WeekNo, @SequenceNo, ''' + qCommonWidthsWidth.Value + ''', ''' + tblSizeRangeSizesSize.Value + ''', 0, ' + IntToStr(qCommonWidthsNo.Value) + ', ' + FloatToStr(tblSizeRangeSizesSeq.Value) + ');');
                    end;
{
                    tblTicketsInput.Append;
                    tblTicketsInputWeekNo.Value := WeekNumber;
