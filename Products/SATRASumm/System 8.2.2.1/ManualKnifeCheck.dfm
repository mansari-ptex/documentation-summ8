object fmManualKnifeCheck: TfmManualKnifeCheck
  ...
  object qManualKnives: TFDQueryPlus
    ...
    SQL.Strings = (
        ...
        '//SELECT DISTINCT KS.Code as KnifeCode, P.Code as PartCode, CAST' +
        '(IIF((M.Type = '#39'S'#39') OR (M.Type = '#39'R'#39'), '#39'Synthetic'#39', '#39#39') as SQL_C' +
        'HAR) as MType'
      ...
      ''
        ...
        'R) as MType'
      'FROM KnifeSets KS'
      '  LEFT JOIN PtWidKnf PWK ON PWK.Knife = KS.Code '
      '  LEFT JOIN Parts P ON P.Code = PWK.Part'
      '  LEFT JOIN Material M ON M.Code = P.Material   '
      'WHERE KS.ManualEntry = True'
      'Order By KS.Code, KS.Code')
    Left = 30
    Top = 56
