...
uses
  ...
  Cututils_Summs8 in '..\..\Common\Cututils_Summs8.pas' {dmCutUtils_Summs8: TDataModule},
  Cmntypes in '..\..\Common\Cmntypes.pas',
  Times2_Summs8 in 'Times2_Summs8.pas' {dmTimes2_Summs8: TDataModule},
  ...
  Times_Summs8 in 'Times_Summs8.pas' {dmTimes_Summs8: TDataModule},
  CutUtils2_Summs8 in '..\..\Common\CutUtils2_Summs8.pas' {dmCutUtils2_Summs8: TDataModule},
  ...
  CutUtils2_Summs7 in '..\..\Common\CutUtils2_Summs7.pas' {dmCutUtils2_Summs7: TDataModule},
  Cututils_Summs7 in '..\..\Common\Cututils_Summs7.pas' {dmCutUtils_Summs7: TDataModule},
  Times_Summs7 in 'Times_Summs7.pas' {dmTimes_Summs7: TDataModule},
  Times2_Summs7 in 'Times2_Summs7.pas' {dmTimes2_Summs7: TDataModule},
  ConstructionAllowance in 'ConstructionAllowance.pas' {fmConstructionAllowance},
  ConstructionAllowanceFull in 'ConstructionAllowanceFull.pas' {fmConstructionAllowanceFull},
...
begin
  ...
  Application.CreateForm(TdmCutUtils_Summs7, dmCutUtils_Summs7);
  Application.CreateForm(TdmCutUtils_Summs8, dmCutUtils_Summs8);
  Application.CreateForm(TdmCutUtils2_Summs7, dmCutUtils2_Summs7);
  Application.CreateForm(TdmCutUtils2_Summs8, dmCutUtils2_Summs8);
  Application.CreateForm(TdmTimes_Summs7, dmTimes_Summs7);
  Application.CreateForm(TdmTimes2_Summs7, dmTimes2_Summs7);
