...
type
  TfmStyleDetails = class(TForm)
    ...
    procedure tblStyConstructionsBeforeRefresh(DataSet: TDataSet);
  private
...
procedure TfmStyleDetails.tblStyConstructionsBeforeRefresh(DataSet: TDataSet);
begin
  fmSumms.qConstructions.Refresh;
end;
...
procedure TfmStyleDetails.LocalConnectionSummsAfterConnect(Sender: TObject);
begin
