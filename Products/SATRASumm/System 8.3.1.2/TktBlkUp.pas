...
type
  TfmTicketBulkUpdate = class(TForm)
    ...
    qTicketTickets: TFDQuery;
    qTicketTicketsWeekNo: TSmallintField;
    qTicketTicketsSequenceNo: TSmallintField;
    qTicketTicketsTicketNo: TSmallintField;
    qTicketTicketsMaterialCode: TStringField;
    ...
    procedure dbgTktBlkUpdateKeyPress(Sender: TObject; var Key: Char);
    procedure tblTicketBulkUpdateBeforePost(DataSet: TDataSet);
...
procedure TfmTicketBulkUpdate.dbgTktBlkUpdateKeyPress(Sender: TObject;
  var Key: Char);
begin
  if ord(Key) = VK_RETURN then
  begin
    with (Sender as TDBGridPlus) do
    begin
...
procedure TfmTicketBulkUpdate.tblTicketBulkUpdateBeforePost(DataSet: TDataSet);
begin
...
procedure TfmTicketBulkUpdate.tblTicketBulkUpdateAfterInsert(
  DataSet: TDataSet);
begin
  //Below moved to the Before Post
  // tblTicketBulkUpdateIdentifier.value := Identifier;
end;

procedure TfmTicketBulkUpdate.LocalConnectionSummsAfterConnect(Sender: TObject);
begin
