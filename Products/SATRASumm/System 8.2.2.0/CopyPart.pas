...
begin
  ...
  qParts.SQL.Text := 'INSERT INTO Parts (Code, Description, Rest, Contingency, Material, SizeScale, SizeRange, ' +
                     ...
                     'INSERT INTO PtWidKnf (Part, WidthNo, Knife, Seq, Frequency, NoIncludedKnives, SizeScale, SizeRange, ' +
                     'SizeRelationship, SizeAdjustment) SELECT ''' + QS(Code) + ''', WidthNo, Knife, Seq, Frequency, NoIncludedKnives, ' +
...
procedure TfmCopyPart.LocalConnectionSummsAfterConnect(Sender: TObject);
begin
