...
{$ENDIF}
  ...
  {$IFDEF DEBUGFULL}
    fmDebugger.DrawDistanceLines(PatternWithDist1, PatternWithDist2);
  {$ENDIF}
  ...
  begin
    ...
    {$IFDEF DEBUGFULL}
      fmDebugger.DrawDistanceLinesRemaining(PatternWithDist1, PatternWithDist2);
    {$ENDIF}
...
//    {$ENDIF}
    ...
    {$IFDEF DEBUGFULL}
     fmDebugger.DrawMerge(MergedPattern);
    {$ENDIF}
