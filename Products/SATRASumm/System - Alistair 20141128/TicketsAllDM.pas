...
uses
  ...
  FireDAC.Comp.Client, FDQueryPlus, Controls, Forms, BasicAlw, CmnTypes, cmnVars, FDTablePlus;
...
begin
  ...
  begin
    ...
    //    use the same connection as the rest of the process that calls this unit.
...
begin
  for i := 0 to Length(ConnectionNest) - 1 do
    ConnectionNest[i] := nil;

  SetLength(ConnectionNest, 0);
end;
