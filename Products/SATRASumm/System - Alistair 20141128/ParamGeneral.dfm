object fmParametersGeneral: TfmParametersGeneral
  ...
  object pcParameters: TPageControl
    ...
    object tsCuttingElements: TTabSheet
      ...
      ImageIndex = 7
      object dbgElements: TDBGridPlus
        AlignWithMargins = True
        Left = 3
        Top = 3
        Width = 539
  ...
  object tblElementTimes: TFDTablePlus
    BeforeInsert = tblElementTimesBeforeInsert
    BeforeDelete = tblElementTimesBeforeDelete
    IndexName = 'CODE'
    Connection = LocalConnectionSumms
    ...
    Left = 274
    Top = 370
    object tblElementTimesCode: TStringField
      FieldName = 'Code'
      Size = 10
    end
    object tblElementTimesTime: TFloatField
      FieldName = 'Time'
      DisplayFormat = '0.0000'
      EditFormat = '0.0000'
    end
    object tblElementTimesDescription: TStringField
      FieldKind = fkLookup
      FieldName = 'Description'
