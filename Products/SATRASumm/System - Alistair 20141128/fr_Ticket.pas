...
uses
  ...
  BasicAlw, ExtCtrls, jpeg, frxBarcode, frxReportPlus;
...
begin
  ...
  qMakeGrid.SQL.Clear;
  qMakeGrid.SQL.Text := 'TRY DROP TABLE #Temp; CATCH ALL END;';
  try
    qMakeGrid.ExecSQL;
  except
    beep;
...
//    qTicketTimes.Refresh;
  ...
  begin
    ...
    for i := 0 to RowsInLeatherGridForTicket do
      ...
      begin
        if i = 0 then
          qStr := qStr + 'INSERT INTO #Temp(Area, Qual) VALUES (0,' + IntToStr(AdjQualCoeff + MidCol - j) + '); '
        else
          qStr := qStr + 'INSERT INTO #Temp(Area, Qual) VALUES (' +  IntToStr(qTicketsMaterialAreaCoeff.value + MidRow - i) + ', ' + IntToStr(AdjQualCoeff + MidCol - j) + '); ';
      end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        qStr := qStr + 'INSERT INTO #Temp(Width, RF, Allowance) VALUES (' + IntToStr(i) + ', ''' + TicketTranslation[30] + ' ' + qTicketsMaterialUnitDescription.value + ''',' + AlwStr + '); ';
      end;
      qStr := qStr + 'INSERT INTO #Temp(Width, RF, Allowance) VALUES (9999, ''' + ticketTranslation[30] + ' ' + qTicketsMaterialUnitDescription.value + ''', ' + TimeStr + '); ';
      qMakeGrid.SQL.Text := qStr;
      qMakeGrid.ExecSQL;
      qSynthGrid.Open;
