...
uses
  Summs, SummsVars, Adjfact, BasicAlw, CmnTypes, General;
...
begin
  ...
  mMemo := frWholeStyle.FindObject('Memo34') as TfrxMemoView;
  ...
  qTempTable.SQL.Text := 'TRY' +
                         ...
                         'CREATE TABLE #Temp(Part char(20), Size char(10), ' +
  ...
  qTempTable.SQL.Text := 'TRY' +
                         ...
                         'CREATE TABLE #TempTotals(Size char(10), Width char(10), ' +
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if PartError then
          messagedlg('Report cannot be generated due to error' + #13 + 'calculating allowance for Part: ' +
            Part + '  Width: ' + qCommonWidthsWidth.value + #13 + #13 + Allowance.Error, mtError, [mbOK], 0)
        else
        begin
          ...
          begin
            ...
            if PartError then
              messagedlg('Report cannot be generated due to error' + #13 + 'calculating allowance for Part: ' +
                Part + #13 + #13 + Allowance.Error, mtError, [mbOK], 0)
    ...
    begin
      ...
      if Preview then
        frWholeStyle.ShowPreparedReport
      else
        frWholeStyle.Print;
    end;
  end
  ...
  begin
    qConParts.Close;
    MessageDlg('No Parts for Style', mtInformation, [mbOK], 0)
  end;
end;
