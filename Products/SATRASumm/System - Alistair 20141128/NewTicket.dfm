object fmNewTicket: TfmNewTicket
  ...
  object qAreThereSizes: TFDQueryPlus
    Connection = LocalConnectionSumms
    SQL.Strings = (
      'SELECT COUNT(*) as NumberOfSizes'
      'FROM TicketsInput'
    ...
    object qAreThereSizesNumberOfSizes: TIntegerField
      FieldName = 'NumberOfSizes'
    end
  end
  object qNewTicketSequence: TFDQueryPlus
    Connection = LocalConnectionSumms
    SQL.Strings = (
      'SELECT MAX(SequenceNo + 1) AS SequenceNo'
      '   FROM TicketSequences WHERE WeekNo = :WeekNo OR WeekNo = 0')
    Left = 175
    Top = 27
    ParamData = <
      item
    ...
    object qNewTicketSequenceSequenceNo: TIntegerField
