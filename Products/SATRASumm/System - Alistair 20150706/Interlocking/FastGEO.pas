...
function IntersectExcludingColinearity(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out ix, iy :TFloat):Boolean;                                          overload;
...
(* End of SegmentIntersect *)
function IntersectExcludingColinearity(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out ix,iy:TFloat):Boolean;
var
  UpperX    : TFloat;
  UpperY    : TFloat;
  LowerX    : TFloat;
  ...
  Ratio     : TFloat;
begin
  //TAH version of Insersect which DOES NOT regard colinearity as intersecting
  //*One change to original routine marked below
  ...
  *)
  ...
  begin
    ...
    begin
      ix := x3;
      iy := y3;
      Result := False;  //*Change to main routine here
    end
    else
    begin
      ix := x4;
