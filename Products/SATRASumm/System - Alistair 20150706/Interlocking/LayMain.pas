...
var
  ...
  PerimeterKnife, PerimeterHull: real;
  SPerimeterKnife, sPerimeterHull: string;
...
begin
  ...
  PerimeterHull := Perimeter(MakeConvexHull(Knife.PatternPoints));
