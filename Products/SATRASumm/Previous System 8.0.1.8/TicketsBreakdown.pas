...
//  qChangeTicketsInput.Connection := LocalConnectionSumms;
  ...
  try
    ...
    dmTicketsAllLocal.qReadCompareGrid.paramByName('Identifier').AsString := Identifier;
...
//          SetUpPairageGrid;
    ...
    dmTicketsAllLocal.qClearCompareGrid.paramByName('Identifier').AsString := Identifier;
        ...
        begin
          ...
          begin
            ...
            try
              ...
              dmTicketsAllLocal.qWidthKnives.ParamByName('WeekNo').AsString := sWeekNo;
              dmTicketsAllLocal.qWidthKnives.ParamByName('SequenceNo').AsString := sSequenceNo;
...
//    Caption := 'Ticket(s) : ' + sWeekNo + '/' + sSequenceNo + '/xx    ';
    ...
    begin
      ...
      begin
        qGetMadeInPairsFromConstruction.ParamByName('Construction').AsString := Construction;
...
begin
  ...
  fmfrTicketLocal.qTickets.SQL.Text := 'SELECT TT.*, TS.Style, TS.Construction, TS.TagNo, TS.Customer, TS.Picture, TS.RowsInLeatherGrid, TS.LinesInLeatherGrid ' +
