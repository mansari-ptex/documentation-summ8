...
begin
  ...
  qParts.ParamByName('Code').AsString := Code;
  qParts.ParamByName('SizeRange').AsString := SizeRange;
  qParts.ParamByName('WidthRange').AsString := WidthRange;
  qParts.ParamByName('Material').AsString := Material;
  qParts.ParamByName('MadeInPairs').AsBoolean := MadeInPairsDefault;
  qParts.ParamByName('SLMAllowance').AsBoolean := Option_FullSynthetics;
  ...
  try
    ...
    begin
      qPartsGetError.ParamByName('SizeRange').AsString := SizeRange;
      qPartsGetError.open;
