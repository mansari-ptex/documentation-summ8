...
begin
  try
    ...
    qFirstLast.ParamByName('SReln').AsString := SizeRelationshipCode;
    qFirstLast.open;
...
begin
  qSizeInScale.parambyName('Range').AsString := tblSizeRelationshipsRange.value;
  qSizeInScale.parambyName('Size').AsString := tblSizeRelationshipSizesKnifeSize.value;
