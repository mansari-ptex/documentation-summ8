...
begin
  ...
  try
    ...
    begin
      NumberOfPatterns := 0;
      MessageDlgPos('Unknown File Type', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
    end
    else
    begin
    ...
    //FILTER WAS HERE
            ...
            begin
              MessageDlgPos('Zero points in knife ' + piecename[i] + ' - ' + #13 + 'Knife ignored', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
  ...
  //FILTER WAS HERE
                      ...
                      begin
                        MessageDlgPos('Too few points in knife ' + piecename[NumberOfPatterns - 1] + ' - ' + #13 + 'Knife ignored', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
  ...
  //FILTER WAS HERE
                    ...
                    begin
                      ...
                      CoordList.Free;
                      MessageDlgPos('Too few points in knife ' + piecename[NumberOfPatterns - 1] + ' - ' + #13 + 'Ignoring knife', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
                      PieceName[NumberOfPatterns - 1] := '';
                      NumberOfPatterns := NumberOfPatterns - 1;
                    end;
                  end;
  ...
  begin
    NumberOfPatterns := 0;
    MessageDlgPos('Unknown File Type', mtError, [mbOK], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
  end;
...
begin
  ...
  begin
    MessageDlgPos('Illegal File name', mtInformation, [mbAbort], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
    Opened := False;
    close;
  end;
