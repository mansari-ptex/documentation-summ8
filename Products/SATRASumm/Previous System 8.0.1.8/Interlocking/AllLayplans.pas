...
begin
  if qLayplans.active then
    qLayPlans.Close;
  qlayplans.ParamByName('KnifeCode').AsString := fmLayplan.KnifeCode;
  qlayplans.ParamByName('KnifeScale').AsString := fmLayplan.KnifeScale;
  qlayplans.ParamByName('KnifeSize').AsString := fmLayplan.KnifeSize;
  qLayplans.Open;
end;
