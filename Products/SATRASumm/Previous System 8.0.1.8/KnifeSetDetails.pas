...
uses
  ...
  Vcl.DBGrids, frxReportPlus, FDConnectionPlus;
...
type
  TfmKnifeSetDetails = class(TForm)
    ...
    tblKnifeSetsVeryDiffPosn: TBooleanField;
    tblKnifeSetsVeryDiffPosnYesNo: TStringField;
    pnlView5: TPanel;
    dbtVeryDiffPosnYesNo: TDBText;
    dbcbVeryDiffPosn: TDBCheckBox;
    ...
    procedure DisplayPatternRealSize(Code, Scale, Size: String;
                                     clBackground, clPattern: integer;
                                     var KnifeIn: TPointArray;
                                     RotationAngle: Real; imgPattern: TImage);
...
begin
  ...
  begin
    ...
    begin
      if MessageDlgPos('Save Changes to Knife ' + KnifeCode + '?', mtConfirmation, [mbYes, mbNo], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top)) = mrYes then
        btnSave.click
      else
        btnCancel.click;
    end;
...
//    Caption := 'Knife : ' + KnifeCode;
    ...
    begin
      MessageDlgPos('Knife ' + KnifeCode + ' does not exist', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
      Caption := 'Knife : Not Found';
      close;
    end
    else
    begin
...
begin
  qKnifeInUse.ParamByName('KnifeCode').AsString := KnifeCode;
  qKnifeInUse.open;
...
begin
  ...
  begin
    ...
    dbcbVeryDiffPosn.Enabled := false;
    dbcbDoubleSided.DataField := '';
    dbcbThin.DataField := '';
    dbcbVeryDiffPosn.DataField := '';
...
begin
  ...
  if (VarName = 'VeryDiffPosn') then
    Value := tblKnifeSetsVeryDiffPosnYesNo.value;
...
begin
  if lblSumms6Assessed.Visible then
    MessageDlgPos('Cannot enlarge knives assessed in Version 6', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top))
  else
    imgDblClick(Sender);
end;
...
begin
  ...
  begin
    ...
    begin
      //A preceeding Horrible solution but necesary as no knives can't have angles
      //changed. This solution works if a little ugly.
      s := 'Cannot change angles for no knives.' + #13#13 +
           'Add knives to use Angle.';
...
begin
  if ItemGone(tblKnifeSets, KnifeCode) then
    Close
  else if not fmSumms.CheckDongle(FAST_PRESENCE_CHECK) then
  begin
    if LocalConnectionSumms.InTransaction then
      ShowMessage('InT');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        MessageDlgPos('Cannot close child form', mtInformation, [mbOK], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
    end
    else
    begin
...
begin
  ...
  begin
    ...
    if LockSuccess then
    begin
      qCheckForLayplans.ParamByName('KnifeCode').AsString := KnifeCode;
      ...
      begin
        ...
        try
          ...
          begin
            qDeleteLayplans.ParamByName('KnifeCode').AsString := KnifeCode;
...
begin
  ...
  begin
    ...
    mMemo.Visible := Option_CuttingTimes;
    mMemo := frKnife.FindObject('mVeryDiffPosnTitle') as TfrxMemoView;
    mMemo.Visible := Option_CuttingTimes;
    mMemo := frKnife.FindObject('mVeryDiffPosn') as TfrxMemoView;
    mMemo.Visible := Option_CuttingTimes;
...
begin
  ...
  btnReassess.Visible := ShowReassessButton and (not ManualEntry);
...
begin
  ...
  if tblKnifeSetsVeryDiffPosn.value then
    tblKnifeSetsVeryDiffPosnYesNo.value := 'Yes'
  else
    tblKnifeSetsVeryDiffPosnYesNo.value := 'No';
end;
...
begin
  ...
  if SecondProcessInUse then
    MessageDlgPos('Cannot close whilst drawing pictures', mtInformation, [mbOk], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
end;
...
begin
  ...
  dbcbVeryDiffPosn.TabStop := Editing;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          qSizeScaleSizes.ParamByName('SizeScale').AsString := tblKnifeSetsSizeScale.value;
...
begin
  ...
  begin
    ...
    DisplayPatternRealSize(KnifeCode, KnifeSizeScale, sgKnives.Cells[0, sgKnives.Row], clHide, clCut, Knife, tblKnivesAngle.value, imgPrint);
...
//          (imgPrint.height > papery) and (imgPrint.width <= paperx)) then
      ...
      begin
        ...
        case MessageDlgPos('Knife is ' + sStill + 'too big for paper size and/or will print in margin area.' + sLineBreak + sLineBreak + 'Select a larger paper size.', mtWarning, [mbIgnore, mbOK, mbCancel], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top)) of
          mrIgnore:
          begin
...
begin
  ...
  begin
    ...
    qCheckForLayplansPerSize.ParamByName('KnifeCode').AsString := KnifeCode;
    qCheckForLayplansPerSize.ParamByName('KnifeSizeScale').AsString := KnifeSizeScale;
    qCheckForLayplansPerSize.ParamByName('KnifeSize').AsString := KnifeSize;
...
begin
  //Pieces...
  qInterlocks.ParamByName('KnifeCode').AsString := KnifeCode;
  qInterlocks.ParamByName('KnifeSizeScale').AsString := KnifeSizeScale;
  qInterlocks.ParamByName('KnifeSize').AsString := KnifeSizeToUse;
  qInterlocks.Open;
  ...
  //...then Knives used
  qInterlockKnives.ParamByName('KnifeCode').AsString := KnifeCode;
  qInterlockKnives.ParamByName('KnifeSizeScale').AsString := KnifeSizeScale;
  qInterlockKnives.ParamByName('KnifeSize').AsString := KnifeSizeToUse;
...
begin
  if not fmSumms.CheckDongle(FAST_PRESENCE_CHECK) then
  begin
    if MessageDlgPos('Reassess knife?', mtConfirmation, [mbYes, mbNo], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top)) = mrYes then
    begin
...
procedure TfmKnifeSetDetails.DisplayPatternRealSize(Code, Scale, Size: String;
...
procedure TfmKnifeSetDetails.dlgOpenPatternFileShow(Sender: TObject);
var
  dlgRect: TRect;
