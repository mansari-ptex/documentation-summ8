...
begin
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            qGetData.ParamByName('AdjFactor').AsFloat := AdjFactor;
            ...
            qGetData.paramByName('Construction').AsString := Construction;
            qGetData.Open;
            ...
            if not NotAvailableCostedMC1 then
              NotAvailableSampleMC1 := (CostedMaterialCostPerPair <> 0);
    ...
    begin
      ...
      spKnivesForStyle.ParamByName('Style').AsString := Style;
      spKnivesForStyle.Open;
      tblKnifeSizeDetails.Tablename := '#TempKnifeSizes';
      tblKnifeSizeDetails.Open;
      tblPtWidAF.Open;
      tblPtWidKnf.Open;
      qMaterials.ParamByName('Style').AsString := Style;
      qMaterials.Open;
...
begin
  qAdjustedSize.ParamByName('PartCode').AsString := tblPtWidKnfPart.Value;
  qAdjustedSize.ParamByName('WidthNo').AsInteger := tblPtWidKnfWidthNo.Value;
  qAdjustedSize.ParamByName('KnifeCode').AsString := tblPtWidKnfKnife.Value;
  qAdjustedSize.ParamByName('Size').AsString := qConPartsSampleSize.Value;
  qAdjustedSize.Open;
  tblPtWidKnfRealSampleSize.Value := qAdjustedSizeAdjSize.Value;
  qAdjustedSize.Close;
  qAdjustedSize.ParamByName('Size').AsString := qConPartsCostedSize.Value;
  qAdjustedSize.Open;
