...
begin
  ...
  begin
    ...
    if LockSuccess then
    begin
      qRelationshipsExist.paramByName('Range').AsString := SizeRangeCode;
...
begin
  ...
  begin
    qValidSampleCostedSizes.paramByName('Range').AsString := tblSizeRangesRange.value;
    qValidSampleCostedSizes.paramByName('SampleSize').AsString := tblSizeRangesSampleSize.value;
    qValidSampleCostedSizes.paramByName('CostedSize').AsString := tblSizeRangesCostedSize.value;
