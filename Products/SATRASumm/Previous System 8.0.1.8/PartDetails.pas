...
//Called from SummsThreads
  ...
  qMaterials.paramByname('Material').AsString := tblPartsMaterial.value;
  qMaterials.open;
...
begin
  qDefaultWidth.ParamByName('WidthRange').AsString := tblPartsWidthRange.value;
  qDefaultWidth.Open;
...
//    Caption := 'Part : ' + PartCode;
    ...
    begin
      ...
      qWidthsForRange.paramByname('WidthRange').AsString := tblPartsWidthRange.value;
      ...
      begin
        qDefaultRelationship.ParamByName('PartCode').AsString := PartCode;
...
begin
  ...
  begin
    ...
    qPtWidAF.paramByName('PartCode').AsString := PartCode;
    qPtWidAF.paramByname('WidthRange').AsString := tblPartsWidthRange.value;
    qPtWidAF.open;
...
begin
  ...
  begin
    ...
    qUpdateSLMAlwFlag.ParamByName('Part').AsString := PartCode;
    qUpdateSLMAlwFlag.ParamByName('Legacy').AsBoolean := Option_LegacySynthetics;
...
begin
  ...
  begin
    qSizeRangeSizes.ParamByName('SizeRange').AsString := tblPartsSizeRange.value;
...
begin
  qPartInUse.ParamByName('PartCode').AsString := PartCode;
  qPartInUse.open;
...
begin
  ...
  qWidthsForRange.paramByname('WidthRange').AsString := dbeWidthRange.Text;
  qWidthsForRange.open;
  ...
  begin
    qDefaultWidth.ParamByName('WidthRange').AsString := dbeWidthRange.Text;
    qDefaultWidth.Open;
...
begin
  ...
  begin
    ...
    if not Failed then
    begin
      //CJY retaining cbWidthForRange value despite refresh as described
      sWFR := cbWidthsForRange.Text;
      ...
      //CJY Will only retain if still available after refresh.
      iWFR := cbWidthsForRange.Items.IndexOf(sWFR);
      if (iWFR >= 0) then
      begin
        cbWidthsForRange.ItemIndex := iWFR;
        cbWidthsForRange.OnChange(cbWidthsForRange);
      end;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    qAdjustedKnifeSizes.ParamByName('PartCode').AsString := PartCode;
    qAdjustedKnifeSizes.ParamByName('WidthNo').AsInteger := WidthNoForWidth(cbWidthsForRange.text);
