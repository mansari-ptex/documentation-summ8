...
begin
  ...
  try
    ...
    dmTimes2.qKnivesForValue.paramByName('Code').AsString := Code;
    dmTimes2.qKnivesForValue.paramByName('WidthNo').AsInteger := WidthNo;
...
begin
  ...
  try
    ...
    begin
      dmTimes2.qPatternsForValue.paramByName('Code').AsString := Code;
      dmTimes2.qPatternsForValue.paramByName('WidthNo').AsInteger := WidthNo;
