        ...
        begin
          ...
          try
            ...
            begin
              ...
              dmTicketsAll.qWidthKnives.ParamByName('WeekNo').AsInteger := qTicketSequencesWeekNo.Value;
              dmTicketsAll.qWidthKnives.ParamByName('SequenceNo').AsInteger := qTicketSequencesSequenceNo.Value;
            ...
            dmTicketsAll.qClearCompareGrid.paramByName('Identifier').AsString := Identifier;
