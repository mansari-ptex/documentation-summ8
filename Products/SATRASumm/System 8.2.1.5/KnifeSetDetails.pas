...
uses
  ...
  KnifeInterlock, KnifeSpinner, Dongle_Green, KnifeNettArea;
...
var
  i: integer;
  SQLString: string;
  SizesArray: array of string;
  dmKnifeNettArea: TdmKnifeNettArea;

begin
  SetLength(SizesArray, 0);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if sgKnives.Cells[6, i] <> '' then
          begin
            SetLength(SizesArray, Length(SizesArray) + 1);

            SizesArray[Length(SizesArray) - 1] := sgKnives.Cells[0, i];
          end;
        end;
        ...
        for i := 0 to Length(SizesArray) - 1 do
        begin
          dmKnifeNettArea := TdmKnifeNettArea.Create(Self, LocalConnectionSumms);
          dmKnifeNettArea.NettArea(QS(KnifeCode), QS(KnifeSizeScale), SizesArray[i]);
...
begin
  ...
  begin
    ...
    fmCopyKnife.BaseManual := ManualEntry;
...
procedure TfmKnifeSetDetails.LocalConnectionSummsAfterConnect(Sender: TObject);
begin
