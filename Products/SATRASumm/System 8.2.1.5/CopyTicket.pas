...
begin
  ...
  begin
    ...
    begin
      ...
      qCopyTickets.SQL.Text := 'INSERT INTO TicketSequences(WeekNo, SequenceNo, Style, StyleDescription, Construction, Picture) ' +
                               'SELECT ' + sWeekNo + ' AS WeekNo, ' + IntToStr(SequenceNo) + ' AS SequenceNo, ' +
                                          'Style, StyleDescription, Construction, Picture ' +
...
procedure TfmCopyTicket.LocalConnectionSummsAfterConnect(Sender: TObject);
begin
