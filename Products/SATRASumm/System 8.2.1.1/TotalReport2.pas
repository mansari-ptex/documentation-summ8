...
uses
  SysUtils, Classes, Windows, Forms, Controls, Times_Summs7, Times_Summs8, DB, FireDAC.Stan.Intf,
  FireDAC.Stan.Option, FireDAC.Stan.Param,FireDAC.Stan.Error, FireDAC.DatS,
  FireDAC.Phys.Intf, FireDAC.DApt.Intf,FireDAC.Stan.Async, FireDAC.DApt,
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, FDQueryPlus, FDTablePlus, Dialogs, frxClass,
  frxDBSet, frxReportPlus, CmnVars, Datasnap.DBClient;

type
  TdmTotalReport2 = class(TDataModule)
    ...
    spKnivesForStyle2: TFDStoredProc;
    spKnivesForStyle2KnifeCode: TStringField;
    spKnivesForStyle2Description: TStringField;
    spKnivesForStyle2Type: TStringField;
    spKnivesForStyle2Manual: TStringField;
    spKnivesForStyle2CutGap: TSmallintField;
    spKnivesForStyle2DblSided: TStringField;
    spKnivesForStyle2ThinKniife: TStringField;
    spKnivesForStyle2Pieces: TSmallintField;
    spKnivesForStyle2Punches: TSmallintField;
    spKnivesForStyle2Clears: TSmallintField;
    spKnivesForStyle2Bands: TFloatField;
    spKnivesForStyle2Marks: TFloatField;
    DataSource3: TDataSource;
    frdbKnivesForStyleSample: TfrxDBDataset;
    frWholeStyle: TfrxReportPlus;
    frdbKnifeSizeDetails_Sample: TfrxDBDataset;
    DataSource4: TDataSource;
    tblKnifeSizeDetails_Sample: TFDTablePlus;
    tblKnifeSizeDetails_SampleCode: TStringField;
    tblKnifeSizeDetails_SampleMeasuredSize: TStringField;
    tblKnifeSizeDetails_SampleGrossArea: TFloatField;
    tblKnifeSizeDetails_SampleNettArea: TFloatField;
    tblKnifeSizeDetails_SampleInterlockArea: TFloatField;
    tblKnifeSizeDetails_SampleAngle: TFloatField;
    ...
    tblKnifeSizeDetails_SampleNettAreaPerPiece: TFloatField;
    spKnivesForStyle2PartCode: TStringField;
    spKnivesForStyle2Seq: TSmallintField;
    spKnivesForStyle2Frequency: TSmallintField;
    tblKnifeSizeDetails_SampleNettAreaPerShoe: TFloatField;
    tblKnifeSizeDetails_SampleNettAreaPerPair: TFloatField;
    spKnivesForStyle2KnifeCodeOrTotal: TStringField;
    spKnivesForStyle2Sample: TBooleanField;
    tblKnifeSizeDetails_SampleSample: TBooleanField;
    memtblSample: TFDMemTable;
    memtblSamplePartCode: TStringField;
    memtblSampleSeq: TSmallintField;
    memtblSampleKnifeCode: TStringField;
    memtblSampleFrequency: TSmallintField;
    memtblSampleDescription: TStringField;
    memtblSampleType: TStringField;
    memtblSampleManual: TStringField;
    memtblSampleCutGap: TSmallintField;
    memtblSampleDblSided: TStringField;
    memtblSampleThinKniife: TStringField;
    memtblSamplePieces: TSmallintField;
    memtblSamplePunches: TSmallintField;
    memtblSampleClears: TSmallintField;
    memtblSampleBands: TFloatField;
    memtblSampleMarks: TFloatField;
    memtblSampleKnifeCodeOrTotal: TStringField;
    memtblSampleSample: TBooleanField;
    memtblCosted: TFDMemTable;
    ...
    memtblCostedKnifeCodeOrTotal: TStringField;
    BooleanField1: TBooleanField;
    frdbKnivesForStyleCosted: TfrxDBDataset;
    tblKnifeSizeDetails_Costed: TFDTablePlus;
    tblKnifeSizeDetails_CostedCode: TStringField;
    tblKnifeSizeDetails_CostedMeasuredSize: TStringField;
    tblKnifeSizeDetails_CostedNettArea: TFloatField;
    tblKnifeSizeDetails_CostedNettAreaPerPiece: TFloatField;
    tblKnifeSizeDetails_CostedNettAreaPerShoe: TFloatField;
    tblKnifeSizeDetails_CostedNettAreaPerPair: TFloatField;
    tblKnifeSizeDetails_CostedGrossArea: TFloatField;
    tblKnifeSizeDetails_CostedInterlockArea: TFloatField;
    tblKnifeSizeDetails_CostedAngle: TFloatField;
    tblKnifeSizeDetails_CostedSample: TBooleanField;
    DataSource11: TDataSource;
    frdbKnifeSizeDetails_Costed: TfrxDBDataset;
    DataSource12: TDataSource;
    tblTempSamplePrNettAreaSqFt: TFloatField;
    tblTempCostedPrNettAreaSqFt: TFloatField;
    tblTempSamplePrWasteArea: TFloatField;
    tblTempCostedPrWasteArea: TFloatField;
    qCommonWidthsPreCheck: TFDQueryPlus;
    SmallintField7: TSmallintField;
    StringField8: TStringField;
    StringField9: TStringField;
    StringField10: TStringField;
    IntegerField1: TIntegerField;
    tblKnifeSizeDetails_SampleMissingKnife: TBooleanField;
    tblKnifeSizeDetails_CostedMissingKnife: TBooleanField;
    tblTempSamplePrNettAreaSqUnits: TFloatField;
    tblTempCostedPrNettAreaSqUnits: TFloatField;
    tblTempSampleAdjToSqUnits: TFloatField;
    tblTempCostedAdjToSqUnits: TFloatField;
    ...
    procedure spKnivesForStyle2CalcFields(DataSet: TDataSet);
    procedure memtblSampleCalcFields(DataSet: TDataSet);
    procedure memtblCostedCalcFields(DataSet: TDataSet);
    procedure tblTempSampleCalcFields(DataSet: TDataSet);
    procedure tblTempCostedCalcFields(DataSet: TDataSet);
  private
    { Private declarations }
    function ChooseWidth(Construction: String): SmallInt;
  public
    { Public declarations }
  end;
...
uses
  Summs, SummsVars, Adjfact, BasicAlw, CmnTypes, General, Cututils_Summs7, Cututils_Summs8, WidthSelector;

{$R *.dfm}

procedure TdmTotalReport2.memtblCostedCalcFields(DataSet: TDataSet);
begin
  if memtblCosted.FieldByName('Seq').AsInteger >= 10000 then
    memtblCosted.FieldByName('KnifeCodeOrTotal').AsString := 'TOTAL'
  else if memtblCosted.FieldByName('Seq').AsInteger > 1000 then
    memtblCosted.FieldByName('KnifeCodeOrTotal').AsString := 'Total'
  else
    memtblCosted.FieldByName('KnifeCodeOrTotal').AsString := memtblCosted.FieldByName('KnifeCode').AsString;
end;

procedure TdmTotalReport2.memtblSampleCalcFields(DataSet: TDataSet);
begin
  if memtblSample.FieldByName('Seq').AsInteger >= 10000 then
    memtblSample.FieldByName('KnifeCodeOrTotal').AsString := 'TOTAL'
  else if memtblSample.FieldByName('Seq').AsInteger > 1000 then
    memtblSample.FieldByName('KnifeCodeOrTotal').AsString := 'Total'
  else
    memtblSample.FieldByName('KnifeCodeOrTotal').AsString := memtblSample.FieldByName('KnifeCode').AsString;
end;

procedure TdmTotalReport2.frWholeStyleBeforePrint(Sender: TfrxReportComponent);
begin
...
procedure TdmTotalReport2.frWholeStyleGetValue(const VarName: string;
  var Value: Variant);
begin
  if (VarName = 'Company') then
    Value := Company
  else if (VarName = 'ReportTitle') then
    Value := 'Area Totals Full Report for Style : ' + qConPartsStyle.Value + #13 + 'Construction : ' + qConPartsConstruction.Value
  else if (VarName = 'ReportTitle2') then
    Value := qConPartsDescription.Value;

  if qConPartsMadeInPairs.Value then
  begin
    if (VarName = '1PrNettAreaTitle') then
      Value := '1 Pair' + #13 + 'Nett Area'
    else if (VarName = '1PrAlwTitle') then
      Value := '1 Pair' + #13 + 'Allowance'
    else if (VarName = 'xPrAlwTitle') then
      Value := IntToStr(BatchSize) + ' Pairs' + #13 + 'Allowance'
    else if (VarName = '1PrWasteAreaTitle') then
      Value := '1 Pair' + #13 + 'Waste Area'
    ...
    else if (VarName = 'NettAreaPerPairTitle') then
      Value := 'Nett Area' + #13 + 'per Pair'
  end
  else
  begin
    if (VarName = '1PrNettAreaTitle') then
      Value := '1 Item' + #13 + 'Nett Area'
    else if (VarName = '1PrAlwTitle') then
      Value := '1 Item' + #13 + 'Allowance'
    else if (VarName = 'xPrAlwTitle') then
      Value := IntToStr(BatchSize) + ' Items' + #13 + 'Allowance'
    else if (VarName = '1PrWasteAreaTitle') then
      Value := '1 Item' + #13 + 'Waste Area'
    else if (VarName = '1PrMatCostTitle') then
      Value := '1 Item' + #13 + 'Material Cost'
    else if (VarName = 'xPrMatCostTitle') then
      Value := IntToStr(BatchSize) + ' Items' + #13 + 'Material Cost'
    else if (VarName = 'NettAreaPerPairTitle') then
      Value := 'Nett Area' + #13 + 'per Item'
  end;
end;

procedure TdmTotalReport2.PrintTotalReport(Style: string;
...
var
  ...
  Dummy: TTicketInts;
  mMemo: TfrxMemoView;
  ChosenWidthNo: SmallInt;
  CuttingTimesAvailable: Boolean;
  SampleAdjInterlocks: RealArray;
  CostedAdjInterlocks: RealArray;
  i: SmallInt;
...
begin
  ...
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleCutGapTitle') as TfrxMemoView;
  mMemo.Visible := Option_LegacySynthetics;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleCutGap') as TfrxMemoView;
  mMemo.Visible := Option_LegacySynthetics;

  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedCutGapTitle') as TfrxMemoView;
  mMemo.Visible := Option_LegacySynthetics;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedCutGap') as TfrxMemoView;
  mMemo.Visible := Option_LegacySynthetics;

  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleDoubleSidedTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleDoubleSided') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleThinTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleThin') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSamplePunchesTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSamplePunches') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleClearsTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleClears') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleBandsTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleBands') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleMarksTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleSampleMarks') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;

  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedDoubleSidedTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedDoubleSided') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedThinTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedThin') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedPunchesTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedPunches') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedClearsTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedClears') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedBandsTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedBands') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedMarksTitle') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  mMemo := frWholeStyle.FindObject('frdbKnivesForStyleCostedMarks') as TfrxMemoView;
  mMemo.Visible := Option_CuttingTimes;
  ...
  begin
    ...
    TfrxMemoView(frWholeStyle.FindObject('mSampleCostedSizeKnives')).Memo.Clear;
    TfrxMemoView(frWholeStyle.FindObject('mSampleCostedSizeKnives')).Memo.Add('Sample/Costed Size:');
  end
  else
  begin
    TfrxMemoView(frWholeStyle.FindObject('mSampleCostedSize')).Memo.Clear;
    ...
    TfrxMemoView(frWholeStyle.FindObject('mSampleCostedSizeKnives')).Memo.Clear;
    TfrxMemoView(frWholeStyle.FindObject('mSampleCostedSizeKnives')).Memo.Add('Sample Size:');
  end;
  ...
  qTempTable.SQL.Text := 'CREATE TABLE #Temp(Part char(20), Size char(10), ' +
                         ...
                         'PrNettAreaSqFt Double, AdjToSqUnits DOUBLE);';
  qTempTable.ExecSQL;
  ...
  begin
    ...
    ChosenWidthNo := ChooseWidth(Construction);

    qCommonWidths.ParamByName('Code').AsString := Construction;
    qCommonWidths.ParamByName('ChosenWidthNo').AsInteger := ChosenWidthNo;
    qCommonWidths.Open;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          SetLength(SampleAdjInterlocks, Length(Allowance.AdjInterlocks));
          for i := Low(Allowance.AdjInterlocks) to High(Allowance.AdjInterlocks) do
            SampleAdjInterlocks[i] := Allowance.AdjInterlocks[i];
          ...
          begin
            ...
            begin
              ...
              SetLength(CostedAdjInterlocks, Length(Allowance.AdjInterlocks));
              for i := Low(Allowance.AdjInterlocks) to High(Allowance.AdjInterlocks) do
                CostedAdjInterlocks[i] := Allowance.AdjInterlocks[i];

              //Match the Bug on Summs 7 Cutting Times on Total Report & Total Report 2 only
              //(It used the Costed AdjInterlocks for the Sample Size here)
              //It makes no difference to Summs 8 cutting times on these reports as it seems
              //AdjInterlocks is not used in Summs 8 times
              if LegacyCuttingTimes and LegacyCuttingTimesExact then
              begin
                SetLength(SampleAdjInterlocks, Length(CostedAdjInterlocks));
                for i := Low(CostedAdjInterlocks) to High(CostedAdjInterlocks) do
                  SampleAdjInterlocks[i] := CostedAdjInterlocks[i];
              end;
            end;
          end
          else
          begin
            ...
            SetLength(CostedAdjInterlocks, Length(SampleAdjInterlocks));
            for i := Low(SampleAdjInterlocks) to High(SampleAdjInterlocks) do
              CostedAdjInterlocks[i] := SampleAdjInterlocks[i];
          end;
          ...
          begin
            ...
            begin
              if LegacyCuttingTimes then
              begin
                dmTimes_Summs7.CalculateAllTimes(TRUE, qGetData.FieldByName('StdBatchSize').value, qGetData, qCuttingTimes, 0, SampleAdjInterlocks, Dummy, TRUE);
                CuttingTimesAvailable := TRUE;
              end
              else
              begin
                dmTimes_Summs8.CalculateAllTimes(TRUE, qGetData.FieldByName('StdBatchSize').value, qGetData, qCuttingTimes, 0, SampleAdjInterlocks, Dummy, TRUE);
                CuttingTimesAvailable := not dmCutUtils_Summs8.MessageShown;
              end;

              //CJY: If CalculateAllTimes finds a min/max error note set Time = 0 and mark as not available;
//              dmTimes_Summs8.CalculateAllTimes(TRUE, qGetData.FieldByName('StdBatchSize').value, qGetData, qCuttingTimes, 0, Allowance.AdjInterlocks, Dummy, TRUE);
//              if not dmCutUtils_Summs8.MessageShown then
            ...
            begin
              ...
              begin
                if LegacyCuttingTimes then
                begin
                  dmTimes_Summs7.CalculateAllTimes(FALSE, qGetData.FieldByName('StdBatchSize').value, qGetData, qCuttingTimes, 0, CostedAdjInterlocks, Dummy, TRUE);
                  CuttingTimesAvailable := TRUE;
                end
                else
                begin
                  dmTimes_Summs8.CalculateAllTimes(FALSE, qGetData.FieldByName('StdBatchSize').value, qGetData, qCuttingTimes, 0, CostedAdjInterlocks, Dummy, TRUE);
                  CuttingTimesAvailable := not dmCutUtils_Summs8.MessageShown;
                end;

                //CJY: If CalculateAllTimes finds a min/max error note set Time = 0 and mark as not available;
//                dmTimes_Summs8.CalculateAllTimes(FALSE, qGetData.FieldByName('StdBatchSize').value, qGetData, qCuttingTimes, 0, Allowance.AdjInterlocks, Dummy, TRUE);
//                if not dmCutUtils_Summs8.MessageShown then
                if CuttingTimesAvailable then
                begin
                  qCuttingTimes.Open;
            ...
            //Following required because we added PrNettAreaSqFt later which is added via the
            //Stored Procedure spKnivesForStyle2, However we will need this in SqUnits
            tblTempSample.FieldByName('AdjToSqUnits').value := SqftToUnits;
            tblTempSample.Post;
    ...
    begin
      ...
      spKnivesForStyle2.FetchOptions.Items := spKnivesForStyle2.FetchOptions.Items - [fiMeta];
      spKnivesForStyle2.Command.FillParams(spKnivesForStyle2.Params);
      spKnivesForStyle2.Prepare;
      spKnivesForStyle2.ParamByName('Style').Value := Style;
      spKnivesForStyle2.ParamByName('ChosenWidthNo').Value := ChosenWidthNo;
      spKnivesForStyle2.Open;

      //Refresh to get the NettArea which is added by
      //the above stored procedure spKnivesForStyle2
      tblTempSample.Refresh;
      tblTempCosted.Refresh;

      memtblSample.cloneCursor(spKnivesForStyle2, False, false);
      memtblSample.Filter := 'Sample = True';
      memtblSample.Filtered := True;

      memtblCosted.cloneCursor(spKnivesForStyle2, False, false);
      memtblCosted.Filter := 'Sample = False';
      memtblCosted.Filtered := True;

      tblKnifeSizeDetails_Sample.Tablename := '#TempKnifeSizes2';
      tblKnifeSizeDetails_Sample.Open;
      tblPtWidAF.Open;
      tblPtWidKnf.Open;
...
procedure TdmTotalReport2.qConPartsCalcFields(DataSet: TDataSet);
begin
...
procedure TdmTotalReport2.qMaterialsCalcFields(DataSet: TDataSet);
var
  temp: string;
...
procedure TdmTotalReport2.spKnivesForStyle2CalcFields(DataSet: TDataSet);
begin
  if spKnivesForStyle2.FieldByName('Seq').AsInteger >= 10000 then
    spKnivesForStyle2.FieldByName('KnifeCodeOrTotal').AsString := 'TOTAL'
  else if spKnivesForStyle2.FieldByName('Seq').AsInteger > 1000 then
    spKnivesForStyle2.FieldByName('KnifeCodeOrTotal').AsString := 'Total'
  else
    spKnivesForStyle2.FieldByName('KnifeCodeOrTotal').AsString := spKnivesForStyle2.FieldByName('PartCode').AsString;
end;

procedure TdmTotalReport2.tblPtWidAFCalcFields(DataSet: TDataSet);
var
  AdjFactor: real;
...
procedure TdmTotalReport2.tblPtWidKnfCalcFields(DataSet: TDataSet);
begin
...
procedure TdmTotalReport2.tblTempCostedCalcFields(DataSet: TDataSet);
begin
  with DataSet do
  begin
    if (FieldByName('PrNettAreaSqFt').AsFloat = 0) or (FieldByName('AdjToSqUnits').AsFloat = 0) then
      FieldByName('PrNettAreaSqUnits').AsFloat := 0
    else
      FieldByName('PrNettAreaSqUnits').AsFloat := FieldByName('PrNettAreaSqFt').AsFloat * FieldByName('AdjToSqUnits').AsFloat;

    if (FieldByName('PrAlw').AsFloat = 0) or (FieldByName('PrNettAreaSqUnits').AsFloat = 0) then
      FieldByName('PrWasteArea').AsFloat := 0
    else
      FieldByName('PrWasteArea').AsFloat := FieldByName('PrAlw').AsFloat - FieldByName('PrNettAreaSqUnits').AsFloat;
  end;
end;

procedure TdmTotalReport2.tblTempSampleCalcFields(DataSet: TDataSet);
begin
  with DataSet do
  begin
    if (FieldByName('PrNettAreaSqFt').AsFloat = 0) or (FieldByName('AdjToSqUnits').AsFloat = 0) then
...
function TdmTotalReport2.ChooseWidth(Construction: String): SmallInt;
var
  fmWidthSelector: TfmWidthSelector;
  WidthNo: SmallInt;

begin
  qCommonWidthsPreCheck.ParamByName('Code').AsString := Construction;
  qCommonWidthsPreCheck.Open;

  if qCommonWidthsPreCheck.RecordCount = 0 then
    //No Common Widths
    WidthNo := -1
  else if qCommonWidthsPreCheck.RecordCount = 1 then
    //First Width is Only Width
    WidthNo := qCommonWidthsPreCheck.FieldByName('No').AsInteger
  else
  begin
    //Select Width
    fmWidthSelector := TfmWidthSelector.Create(Self);

    qCommonWidthsPreCheck.RecNo := 1; //See CJY comment on next loop
    qCommonWidthsPreCheck.Prior;
    while not qCommonWidthsPreCheck.eof do
    begin
      fmWidthSelector.AddWidth(qCommonWidthsPreCheck.FieldByName('No').AsInteger,
                               qCommonWidthsPreCheck.FieldByName('Width').AsString);

      qCommonWidthsPreCheck.Next;
    end;

    fmWidthSelector.ShowModal;
    WidthNo := fmWidthSelector.WidthNo;

    fmWidthSelector.Free;
  end;

  qCommonWidthsPreCheck.Close;

  Result := WidthNo;
end;


procedure TdmTotalReport2.DropTables;
begin
  memtblSample.Close;
  memtblCosted.Close;
  ...
  spKnivesForStyle2.Close;
  tblKnifeSizeDetails_Sample.Close;
  tblKnifeSizeDetails_Costed.Close;
  tblPtWidAF.Close;
  tblPtWidKnf.Close;
  qMaterials.Close;
  qConParts.Close;
  ...
  tblKnifeSizeDetails_Sample.Disconnect;
  tblKnifeSizeDetails_Costed.Disconnect;
