...
begin
  CreateResourceFile('..\Original Elements files\Elements.txt', 'Elements.res', 100);
  CreateResourceFile('..\Original Elements files\CuttingElements.txt', 'CuttingElements.res', 101);
