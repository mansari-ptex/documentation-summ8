object fmNewStyle: TfmNewStyle
  ...
  object cbAutoCreateConstruction: TCheckBox
    Left = 2
    Top = 65
    Width = 217
    Height = 17
  ...
  object qStyleConstructions: TFDQueryPlus
  ...
  object qConstructionsAndStyles: TFDQueryPlus
    Connection = LocalConnectionSumms
    Left = 97
    Top = 65528
  end
