object fmTicketBulkUpdate: TfmTicketBulkUpdate
  ...
  object pcTicketsAndErrors: TPageControl
    ...
    object tsTickets: TTabSheet
      ...
      object dbgTktBlkUpdate: TDBGridPlus
        ...
        TitleFont.Style = []
        OnKeyPress = dbgTktBlkUpdateKeyPress
        Columns = <
          item
            Expanded = False
            FieldName = 'WeekNo'
  ...
  object tblTicketBulkUpdate: TFDTablePlus
    ...
    BeforePost = tblTicketBulkUpdateBeforePost
    Filtered = True
  ...
  object qTicketTickets: TFDQuery
    IndexFieldNames = 'WeekNo;SequenceNo;TicketNo'
    Connection = fmSumms.ConnectionSumms
    FetchOptions.AssignedValues = [evRowsetSize]
    FetchOptions.RowsetSize = 3000
    SQL.Strings = (
      'SELECT WeekNo, SequenceNo, TicketNo, MaterialCode'
      'FROM TicketTickets'
      'ORDER BY WeekNo, SequenceNo, TicketNo')
    Left = 490
    Top = 9
    object qTicketTicketsWeekNo: TSmallintField
      FieldName = 'WeekNo'
      Origin = 'WeekNo'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object qTicketTicketsSequenceNo: TSmallintField
      FieldName = 'SequenceNo'
      Origin = 'SequenceNo'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object qTicketTicketsTicketNo: TSmallintField
      FieldName = 'TicketNo'
      Origin = 'TicketNo'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object qTicketTicketsMaterialCode: TStringField
