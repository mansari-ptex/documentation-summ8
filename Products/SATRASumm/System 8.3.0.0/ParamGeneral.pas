...
type
  TfmParametersGeneral = class(TForm)
    ...
    tblElementTimes_Summs8: TFDTablePlus;
    dsElements_Summs8: TDataSource;
    dbgElements_Summs8: TDBGridPlus;
    ...
    pnlMisc: TPanel;
    tblElementTimes_Summs8Code: TStringField;
    tblElementTimes_Summs8Time: TFloatField;
    tblElementTimes_Summs8Description: TStringField;
    ...
    tblParametersSearchStyleDescriptionDefault: TBooleanField;
    tblParametersSearchStyleDescriptionDefaultYN: TStringField;
    dbcbSearchStyleDescription: TDBCheckBox;
    dbtSearchStyleDescriptionYesNo: TDBText;
    tblParametersLegacyCuttingTimes: TBooleanField;
    cbLegacyCuttingTimes: TDBCheckBox;
    dbtLegacyCuttingTimes: TDBText;
    tblParametersLegacyCuttingTimesYesNo: TStringField;
    tblElementTimes_Summs7: TFDTablePlus;
    tblElementTimes_Summs7Element: TStringField;
    tblElementTimes_Summs7Description: TStringField;
    tblElementTimes_Summs7PerBatch: TBooleanField;
    tblElementTimes_Summs7Time: TFloatField;
    dsElements_Summs7: TDataSource;
    dbgElements_Summs7: TDBGridPlus;
    tblElementTimes_Summs7PerBatchYesNo: TStringField;
    tblParametersLegacyCuttingTimesExact: TBooleanField;
    tblParametersLegacyCuttingTimesExactYesNo: TStringField;
    dbtLegacyCuttingTimesExact: TDBText;
    cbLegacyCuttingTimesExact: TDBCheckBox;
    lblNotRecommended: TLabel;
    tblParametersLegacyCuttingTimesBase: TBooleanField;
    cbLegacyCuttingTimesBase: TDBCheckBox;
    dbtLegacyCuttingTimesBase: TDBText;
    tblParametersLegacyCuttingTimesBaseYesNo: TStringField;
    qElements: TFDQuery;
    qElementsCode: TStringField;
    qElementsDescription: TStringField;
    ...
    procedure tblElementTimes_Summs8BeforeInsert(DataSet: TDataSet);
    procedure tblElementTimes_Summs8BeforeDelete(DataSet: TDataSet);
    ...
    procedure tblElementTimes_Summs7CalcFields(DataSet: TDataSet);
    procedure tblElementTimes_Summs7BeforeDelete(DataSet: TDataSet);
    procedure tblElementTimes_Summs7BeforeInsert(DataSet: TDataSet);
    procedure cbLegacyCuttingTimesClick(Sender: TObject);
...
begin
  ...
  begin
    ...
    dbgElements_Summs7.enabled := false;
    dbgElements_Summs8.enabled := false;
...
procedure TfmParametersGeneral.cbLegacyCuttingTimesClick(Sender: TObject);
begin
  cbLegacyCuttingTimesExact.Visible := cbLegacyCuttingTimes.Checked;
  dbtLegacyCuttingTimesExact.Visible := cbLegacyCuttingTimes.Checked;
  cbLegacyCuttingTimesBase.Visible := cbLegacyCuttingTimes.Checked;
  dbtLegacyCuttingTimesBase.Visible := cbLegacyCuttingTimes.Checked;
  lblNotRecommended.Visible := cbLegacyCuttingTimes.Checked;
end;
...
begin
  ...
  if tblParametersSearchStyleDescriptionDefault.Value then
    tblParametersSearchStyleDescriptionDefaultYN.Value := 'Yes'
  else
    tblParametersSearchStyleDescriptionDefaultYN.Value := 'No';

  if tblParametersLegacyCuttingTimes.value then
    tblParametersLegacyCuttingTimesYesNo.value := 'Yes'
  else
    tblParametersLegacyCuttingTimesYesNo.value := 'No';

  if tblParametersLegacyCuttingTimesExact.value then
    tblParametersLegacyCuttingTimesExactYesNo.value := 'Yes'
  else
    tblParametersLegacyCuttingTimesExactYesNo.value := 'No';

  if tblParametersLegacyCuttingTimesBase.value then
    tblParametersLegacyCuttingTimesBaseYesNo.value := 'Yes'
  else
    tblParametersLegacyCuttingTimesBaseYesNo.value := 'No';
end;
...
begin
  ...
  if tblMatTypes.active and (tblMatTypes.state in [dsEdit, dsInsert]) then
    tblMatTypes.post;
  if tblElementTimes_Summs7.active and (tblElementTimes_Summs7.state in [dsEdit, dsInsert]) then
    tblElementTimes_Summs7.post;
  if tblElementTimes_Summs8.active and (tblElementTimes_Summs8.state in [dsEdit, dsInsert]) then
    tblElementTimes_Summs8.post;
  tblParameters.post;
...
begin
  ...
  tblMatUnits.cancel;
  tblMatTypes.cancel;
  tblElementTimes_Summs7.cancel;
  tblElementTimes_Summs8.cancel;
  ...
  if tblElementTimes_Summs7.active then
  begin
    tblElementTimes_Summs7.refresh;
    dbgElements_Summs7.refresh;
  end;
  if tblElementTimes_Summs8.active then
  begin
    tblElementTimes_Summs8.refresh;
    dbgElements_Summs8.refresh;
  end;
...
begin
  ...
  begin
    dbgElements_Summs7.Columns[3].ReadOnly := not Editing;
    dbgElements_Summs8.Columns[2].ReadOnly := not Editing;
  end;
  ...
  begin
    ...
    dbcbSearchStyleDescription.ReadOnly := False;
    ...
    if Option_CuttingTimes then
    begin
      dbgElements_Summs7.Options := dbgElements_Summs7.Options + [dgEditing];
      dbgElements_Summs7.color := clEditing;
      dbgElements_Summs7.Columns[3].color := clEditing;

      dbgElements_Summs8.Options := dbgElements_Summs8.Options + [dgEditing];
      dbgElements_Summs8.color := clEditing;
      dbgElements_Summs8.Columns[2].color := clEditing;
    end;
  ...
  begin
    ...
    dbcbSearchStyleDescription.ReadOnly := True;
    ...
    begin
      dbgElements_Summs7.Options := dbgElements_Summs7.Options - [dgEditing];
      dbgElements_Summs7.color := clBack;
      dbgElements_Summs7.Columns[3].color := clBack;

      dbgElements_Summs8.Options := dbgElements_Summs8.Options - [dgEditing];
      dbgElements_Summs8.color := clBack;
      dbgElements_Summs8.Columns[2].color := clBack;
    end;
  ...
  begin
    dbgElements_Summs7.enabled := false;
    dbgElements_Summs7.enabled := true;

    dbgElements_Summs8.enabled := false;
    dbgElements_Summs8.enabled := true;
  end;
...
begin
  ...
  begin
    if not tblElementTimes_Summs7.active then
      tblElementTimes_Summs7.open;
    if not tblElementTimes_Summs8.active then
      tblElementTimes_Summs8.open;

    dbgElements_Summs7.Visible := LegacyCuttingTimes;
    dbgElements_Summs8.Visible := not LegacyCuttingTimes;

    if LegacyCuttingTimes then
    begin
      dbgElements_Summs7.align := alClient;
      dbgElements_Summs7.Columns[0].Width := 64; //Without this line, whatever this is set to in environment it returns to smaller - why?!
    end
    else
      dbgElements_Summs8.align := alClient;
  end
...
procedure TfmParametersGeneral.tblElementTimes_Summs8BeforeInsert(DataSet: TDataSet);
begin
  abort;
end;

procedure TfmParametersGeneral.tblElementTimes_Summs7BeforeDelete(DataSet: TDataSet);
begin
  abort;
end;

procedure TfmParametersGeneral.tblElementTimes_Summs7BeforeInsert(DataSet: TDataSet);
begin
  abort;
end;

procedure TfmParametersGeneral.tblElementTimes_Summs7CalcFields(DataSet: TDataSet);
var
  s: string;

begin
  with tblElementTimes_Summs7 do
  begin
    if FieldByName('PerBatch').AsBoolean then
      s := 'Yes'
    else
      s := 'No';

    FieldByName('PerBatchYesNo').AsString := s;
  end;
end;

procedure TfmParametersGeneral.tblElementTimes_Summs8BeforeDelete(DataSet: TDataSet);
begin
  abort;
end;

procedure TfmParametersGeneral.LocalConnectionSummsAfterConnect(
  Sender: TObject);
begin
