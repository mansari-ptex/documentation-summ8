object dmBasAll: TdmBasAll
  ...
  object qSizeScaleSizes: TFDQuery
    IndexFieldNames = 'Scale;Size'
    Connection = fmSumms.ConnectionSumms
    FetchOptions.AssignedValues = [evRowsetSize]
    FetchOptions.RowsetSize = 3000
    SQL.Strings = (
      'SELECT Scale, Size, Length'
      'FROM SizeScaleSizes'
      'ORDER BY Scale, Size')
    Left = 186
    Top = 77
    ...
    object qSizeScaleSizesLength: TSmallintField
      FieldName = 'Length'
      Origin = 'Length'
    end
  end
