...
begin
  ...
  if MessageDlgPos('Delete selected Constructions?', mtConfirmation, [mbYes, mbNo], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top)) = mrYes then
  begin
    ...
    MessageDlgPos('Deletion complete.' + #13#13 + 'Note: Only Constructions that are not' + #13 + 'in use have been deleted.', mtInformation, [mbOK], 0, ((Application.MainForm.Width div 3) + Application.MainForm.Left), ((Application.MainForm.Height div 3) + Application.MainForm.Top));
  end;
...
begin
  ...
  begin
    ...
    begin
      SortOrder(dbgConstructions, Column, SQLString);
