...
//    qTicketMaterials.Refresh;
  if qTicketMaterials.Active then
  begin
    qTicketMaterials.Close;
    qTicketMaterials.Open;
  end;
end;
...
begin
  ...
  //CJY qTicketDetails.FetchOptions.RecordCountMode set to cmTotal
  if qTicketDetails.RecordCount = 0 then
